...
class Register extends Component {
    ...
    submitNewRegister = (e) => {
        e.preventDefault();
        axios.post('http://localhost:3000/Vgt/vgtserver/apiregister', {
            ...
            <div className="container">
                ...
                <div className="container row">
                    <div className="form col-md-6">
                        <form className="form-horizontal" novalidate id="registerForm"  method="POST" action="http://localhost:3000/Vgt/vgtserver/apiregister"  onSubmit={this.submitNewRegister}>
                            ...
                            <div className="form-group divRelative">
                                <input className="form-control registerBirthday birthdayText" required type="date" value={this.state.birthdate}
                            ...
                            <div className="form-group text-center agreeCheckbox"><br />
                                <label htmlhtmlFor="agree" className="agreeLabel myText">
                                    <input name="agree" id="agree" type="checkbox" />註冊即表示同意&nbsp;
