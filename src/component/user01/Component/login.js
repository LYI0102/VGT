...
class Login extends Component {
    ...
    submitNewLogin = (e) => {
        e.preventDefault();
        axios.post("http://localhost:3000/Vgt/vgtserver/apilogin", {
        ...
        return (
            <BrowserRouter>
                <div className="container">
                    <form className="form-horizontal col-sm-offset-3 col-md-offset-3" id="loginForm" method="POST" action="http://localhost:3000/Vgt/vgtserver/apilogin" onSubmit={this.submitNewLogin}>
