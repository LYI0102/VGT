                            ...
                            <ul className="navbar-nav ms-auto ">
                                ...
                                <li className={`nav-item dropdown navItemLine ${this.state.logoutButton}`}>
                                    ...
                                    <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                        <li>
                                            <NavLink className="dropdown-item" to={`/VGT/MemberPage/profile/${this.state.vgtid}`}>個人檔案</NavLink>
                                        </li>
                                        <li>
                                            <NavLink className="dropdown-item" to={`/VGT/MemberPage/storeValue/${this.state.vgtid}`}>儲值中心</NavLink>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <NavLink className={`dropdown-item ${this.state.managePage}`} to="/VGT/vgtPages">管理中心</NavLink>
                                        </li>
                                    </ul>
                                </li>
