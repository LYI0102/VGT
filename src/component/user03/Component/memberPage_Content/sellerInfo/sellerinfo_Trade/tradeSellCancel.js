                    ...
                    <tbody>                        
                        <tr>                           
                            ...
                            <td className="d-flex justify-content-evenly">
                                <NavLink exact to="/VGT/memberPage/sellerInfo/CancelTrade" className="btn" >查看商品詳情</NavLink>
                                <NavLink exact to="/VGT/MemberPage/customerService" className="btn">我要申訴</NavLink>
                            </td>                                                      
                        </tr>
                    </tbody>
                </table>               
