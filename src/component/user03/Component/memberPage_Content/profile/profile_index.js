            ...
            <BrowserRouter>
                <div className="container">
                    <nav aria-label="Page navigation" className=" border-bottom">
                        <ul className="pagination  nav-fill  bg-project">
                            <li className="nav-item bg-project">
                                <NavLink className="nav-link page-link" to={`/VGT/memberPage/profile/basicInfo/${vgtid}`}>個人資訊</NavLink>
                            </li>
                    ...
                    <Switch>
                        ...
                        <Route path="/VGT/memberPage/profile/basicInfo/:vgtid" component={BasicInfo}></Route>
